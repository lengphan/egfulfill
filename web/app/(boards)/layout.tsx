  ...
  return (
    ...
    <div className="min-h-svh bg-background">
      ...
      <div className={collapsed ? "md:pl-16" : "md:pl-60"}>
        ...
        {/* THE STRIP IS A DASHBOARD THING, not a shell thing (owner's call, 2026-09-08).
            It was briefly mounted here so an announcement reached every board — but on a
            working board it lands mid-page, above a scan count or a queue, where a line of
            marketing copy is an interruption rather than a greeting. It stays on /overview
            and the seller dashboard, which are the two pages someone arrives at.
            The SETTINGS still govern it everywhere it appears: one speed, one text. */}
