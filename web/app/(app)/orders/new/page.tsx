...
function VariantSelect({ value, options, onChange, placeholder }: { value: string; options: string[]; onChange: (v: string) => void; placeholder: string }) {
  ...
  return (
    <select
      ...
      className="eg-select h-9 rounded-lg border border-border bg-card px-2 text-sm focus-visible:border-ring focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/40 transition-colors hover:border-primary/40"
    >
