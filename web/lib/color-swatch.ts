...
const MAP: Record<string, string> = {
  ...
  green: "#16a34a", forest: "#14532d", "forest green": "#14532d", kelly: "#22c55e", "kelly green": "#22c55e", olive: "#556b2f", "olive green": "#556b2f", lime: "#84cc16", "camo green": "#6b7f4a", hunter: "#355e3b", "dk green": "#14532d", "dk.green": "#14532d", "ol green": "#556b2f", "ol.green": "#556b2f", mint: "#a7f3d0",
...
function oneHex(raw: string): string | null {
  ...
  s = s.replace(/^\s*\d+\s*[-–]\s*/, "").trim() // strip leading code "016 - "
  if (!s) return null
