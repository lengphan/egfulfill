    ...
    <div className="text-[#0B0B0C]" style={{ background: SURFACE }}>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {steps.map((s, i) => (
            <Rise key={s.title} delay={i * 0.07} className="rounded-2xl border border-black/[0.09] bg-white p-8">
              <div className="font-display font-bold leading-none tracking-tighter text-black/[0.13]" style={{ fontSize: "clamp(3rem, 6vw, 4.5rem)" }}>
      ...
      <section className="py-16" style={{ background: "rgba(0,0,0,0.03)" }}>
        <div className="mx-auto max-w-4xl px-6">
          <h2 className="font-display font-bold leading-[0.95] tracking-[-0.035em]" style={HEADING}>
