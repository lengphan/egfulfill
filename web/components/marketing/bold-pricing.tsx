        ...
        <div className="grid gap-4 lg:grid-cols-[1.25fr_1fr]">
          ...
          <Rise className="rounded-2xl border border-black/[0.09] bg-white p-9">
            ...
            <div className="mt-4 flex items-baseline gap-3">
              <span className="font-display font-bold leading-none tracking-[-0.04em]" style={HEADING}>$0</span>
            ...
            <ul className="mt-7 divide-y divide-black/[0.09] border-y border-black/[0.09]">
              {examples.map((e) => (
                <li key={e.name} className="flex items-center justify-between py-4">
                  ...
                  <span className="text-lg font-display font-bold tabular-nums tracking-tight">{e.price}</span>
                </li>
              ))}
            </ul>
