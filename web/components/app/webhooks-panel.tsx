...
export function WebhooksPanel() {
 ...
 className="text-muted-foreground hover:text-destructive">
                  ...
                  {t && (
                    <div className={"mt-2 rounded border px-2 py-1.5 text-xs " + (t.ok ? "border-shipped/30 bg-shipped/12 text-shipped" : "border-destructive/30 bg-destructive/5 text-destructive")}>
 ...
 return (
                                <tr key={d.id} className="border-t border-border/60 first:border-0">
                                  ...
                                  <td className={"py-1 " + (o.tone === "ok" ? "text-shipped" : "text-destructive")}>{o.text}</td>
