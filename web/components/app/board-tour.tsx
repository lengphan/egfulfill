...
export function BoardTour() {
  ...
  return (
    ...
    <motion.section
      ...
      transition={spring}
      className={"fixed inset-x-3 bottom-3 z-40 flex w-auto flex-col overflow-hidden rounded-2xl bg-popover text-popover-foreground shadow-2xl ring-1 ring-foreground/15 sm:inset-x-auto sm:w-[22.5rem] dark:ring-foreground/20 " + PANEL_POS[corner]}
    >
