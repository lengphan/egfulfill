...
(function () {
  ...
  function injectCSS() {
    ...
    st.textContent =
      ...
      ".epx-card .img{position:relative;height:182px;background:#fff;border-bottom:1.5px solid #191918;display:flex;align-items:center;justify-content:center;overflow:hidden;padding:0}" +
