...
(function () {
  ...
  var css = [
    ...
    '.ni{font-family:' + MONO + '!important;text-transform:uppercase;letter-spacing:.03em;font-size:12.5px;transition:background-color .16s ease,color .16s ease!important}',
